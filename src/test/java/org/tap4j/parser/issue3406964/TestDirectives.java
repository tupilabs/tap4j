 ...
 * 
 * The skip directive in TAP can contain both upper and lower case SKIP and 
 * TO DO text. However tap4j is considering only the upper case version.
 * 
...
public class TestDirectives 
{
	...
	public void testSkipDirective()
	{
		...
		TestSet testSet = consumer.load(new File(TestDirectives.class.getResource("/org/tap4j/parser/issue3406964/ihaveskips.tap").getFile()));
	...
	public void testTodoDirective()
	{
		...
		TestSet testSet = consumer.load(new File(TestDirectives.class.getResource("/org/tap4j/parser/issue3406964/ihavetodoes.tap").getFile()));
		Assert.assertNotNull ( testSet, "Empty Test Set" );
