...
public class TestTap13Representer {
    ...
    public void testPrintTapLines() {
        Tap13Representer representer = new Tap13Representer();
        TapResult testResult = new TestResult(StatusValues.OK, 1);
        StringWriter sw = new StringWriter();
        PrintWriter pw = new PrintWriter(sw);
        representer.printTapLine(pw, testResult);
        assertEquals("ok 1\n", sw.toString());

        TapResult text = new Text("yo");
        sw = new StringWriter();
        pw = new PrintWriter(sw);
        representer.printTapLine(pw, text);
    ...
    public void printBailOut() {
        Tap13Representer representer = new Tap13Representer();
        BailOut bailOut = new BailOut("a reason");
        StringWriter sw = new StringWriter();
        PrintWriter pw = new PrintWriter(sw);
        representer.printTapLine(pw, bailOut);
    ...
    public void printFooter() {
        ...
        StringWriter sw = new StringWriter();
        PrintWriter pw = new PrintWriter(sw);
        representer.printFooter(pw, footer);
    ...
    public void printPlanEmptyAllowed() {
        ...
        StringWriter sw = new StringWriter();
        PrintWriter pw = new PrintWriter(sw);
        assertThrows(RepresenterException.class, () -> representer.printPlan(pw, null));
    }
    ...
    public void printHeader() {
        ...
        StringWriter sw = new StringWriter();
        PrintWriter pw = new PrintWriter(sw);
        representer.printHeader(pw, header);
